...
## Tools Used
Microsoft Excel – data cleaning, validation, and feature creation
Python (pandas, matplotlib, seaborn) – exploratory analysis and visualization
SQL – descriptive statistics and demographic analysis

## Data Cleaning & Preparation
Data cleaning was performed in Excel using clearly defined rules:
Removed records with missing critical fields such as student ID and daily usage
Standardized categorical values (gender, academic level, platforms)
Validated numeric ranges for usage hours, sleep duration, and scores
Removed duplicates
